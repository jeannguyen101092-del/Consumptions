...
def run_ai_dna_matching():
    """
    Hàm bọc độc lập cô lập hoàn toàn lề để triệt tiêu lỗi IndentationError.
    Tự động đồng bộ api_headers, quét tìm mã hàng R09-XXXXXX và khóa cổng bảo mật.
    """
    try:
