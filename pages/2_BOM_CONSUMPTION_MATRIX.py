            ...
            if not gemini_key: 
                ...
                try:
                    ...
                    if has_file:
                        ...
                        elif new_style_id_detected != "UNKNOWN_STYLE" and (not clean_query or clean_query in ["TƯƠNG ĐỒNG", ""]):
                    ...
                    if not dynamic_keyword or len(dynamic_keyword) < 3 or dynamic_keyword == "TƯƠNG ĐỒNG":
