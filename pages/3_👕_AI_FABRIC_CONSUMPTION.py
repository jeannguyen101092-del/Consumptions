...
def allocate_gerber_share_consumption(piece_calculated_data, total_fabric_piece_area, skyline_results):
    ...
    # =====================================================================
    # 🟩 ĐOẠN 2 (PHIÊN BẢN V28 - CHUẨN CAD - NO INDENT): DATA CLEANING & PARAMETER SYNC
    # =====================================================================
    import re
    import pandas as pd
    import streamlit as st

    # 🚨 LỚP BẢO VỆ CHÍ MẠNG: Đảm bảo biến ctx luôn được định nghĩa để không bao giờ bị lỗi sập hệ thống
