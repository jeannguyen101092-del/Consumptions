...
# Kế thừa trực tiếp layer phôi ảo sạch lỗi từ tầng kiểm toán 4B hoặc Session State
...
# Đọc cấu hình khổ vải chính xác từ giao diện UI Streamlit
...
# Tính toán luồng vải lót (Lining)
