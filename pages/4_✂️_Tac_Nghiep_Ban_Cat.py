...
# =============================================================================
# TẦNG 3 - ĐOẠN 6b: PHẦN 2 - RENDERING DATA EDITOR KHÔNG KHÓA Ô & LIÊN KẾT 2 CHIỀU - FIX HOÀN TOÀN CÚ PHÁP V28
# =============================================================================
                ...
                if current_snapshot and r_idx_int < len(current_snapshot):
                    for col_header, new_val in change_dict.items():
                        if str(col_header).startswith("CỠ "):
                            # 🎯 ĐA VÁ LỖI CHÍ MẠNG: Kiểm tra thuộc hàng GIÀNG (0) hoặc SIZE (1) thì lưu dạng chữ Text để giữ chữ 00
                            if r_idx_int in:
