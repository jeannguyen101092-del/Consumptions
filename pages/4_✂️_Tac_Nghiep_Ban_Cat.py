...
# =============================================================================
# TẦNG 3 - ĐOẠN 6b: PHẦN 2 - RENDERING DATA EDITOR KHÔNG KHÓA Ô & LIÊN KẾT 2 CHIỀU - ĐÃ VÁ LỖI CÚ PHÁP V27
# =============================================================================
                ...
                if current_snapshot and r_idx_int < len(current_snapshot):
                    for col_header, new_val in change_dict.items():
                        if str(col_header).startswith("CỠ "):
                            # 🎯 ĐÃ SỬA LỖI CÚ PHÁP: Kiểm tra nếu thuộc hàng GIÀNG (0) hoặc SIZE (1) thì giữ định dạng chữ Text để không mất số 00
                            if r_idx_int in:
