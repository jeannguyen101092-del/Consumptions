...
# =====================================================================
# ĐOẠN 6a: KHỞI TẠO HỆ THỐNG VÀ BỘ CONFIG STYLE ENTERPRISE UI LIỀN KHỐI
# =====================================================================
import streamlit as st
...
# 5. 🌟 BỘ STYLE SẠCH THAY THẾ TOÀN BỘ PHẦN CSS CŨ
st.markdown("""
<style>
    /* Sửa lại link nhúng font Inter chuẩn Google Fonts */
    ...
    /* --- KHỐI THẺ KPI LIỀN KHỐI CHUẨN TẬP ĐOÀN LỚN --- */
    .enterprise-kpi-card {
        background-color: #ffffff !important;
    ...
    /* Đường line viền màu mảnh định danh trên đỉnh */
    .border-style { border-top: 4px solid #334155 !important; }
    .border-items { border-top: 4px solid #0ea5e9 !important; }
    .border-cons  { border-top: 4px solid #f97316 !important; }
    .border-size  { border-top: 4px solid #10b981 !important; }

    .kpi-header { text-align: left !important; margin-bottom: 12px; }
    .kpi-num-light { font-size: 22px !important; font-weight: 700 !important; color: #0f172a !important; line-height: 1.1; }
    .kpi-lbl-light { font-size: 10px !important; font-weight: 600; color: #64748b !important; text-transform: uppercase; letter-spacing: 0.05em; margin-top: 4px; }

    /* Hộp lót ảnh bên trong, bo tròn nằm trọn trong thẻ trắng không lo tràn viền */
    .kpi-image-container {
        background-color: #f8fafc !important;
    ...
    .kpi-image-container img { max-height: 75px !important; width: auto !important; object-fit: contain !important; }

    /* --- KHU VỰC THÂN DƯỚI ĐỐI XỨNG CÂN BẰNG --- */
    .custom-erp-box {
        background-color: #ffffff !important;
        border: 1px solid #e2e8f0 !important;
        border-radius: 12px;
    ...
    /* Trạng thái trống (Empty State) tinh tế */
    ...
    .empty-state-text { font-size: 13px; margin-top: 8px; color: #64748b; }

    .meta-box-light { background-color: #f8fafc; border-left: 3px solid #0ea5e9; padding: 10px 14px; margin-bottom: 8px; border-radius: 0 6px 6px 0; }
    .meta-label-light { font-size: 10px; font-weight: 600; color: #64748b; text-transform: uppercase; }
    ...
    section[data-testid="stSidebar"] h3 { font-size: 11px !important; font-weight: 700 !important; color: #64748b !important; letter-spacing: 0.05em; }
    section[data-testid="stSidebar"] button { background-color: #fff !important; color: #ef4444 !important; border: 1px solid #fee2e2 !important; border-radius: 6px !important; font-size: 12px !important; transition: all 0.2s; }
    section[data-testid="stSidebar"] button:hover { background-color: #fef2f2 !important; border-color: #fca5a5 !important; }
    div[data-testid="stFileUploader"] section { background-color: #f8fafc !important; border: 1px dashed #cbd5e1 !important; border-radius: 8px !important; padding: 12px !important; margin-bottom: 15px; }
</style>
""", unsafe_allow_html=True)
# =====================================================================
