...
with left_panel:
    ...
    if uploaded_file is not None:
        ...
        # 🌟 HIỂN THỊ BẢNG THÔNG SỐ (SPEC SHEET) THỰC TẾ ĐỌC TỪ FILE
...
with right_panel:
    ...
    if uploaded_file is not None:
        # Giả lập khu vực render ảnh Sketch thực tế của áo/quần từ Techpack
        # Trong thực tế sản xuất, bạn có thể thay thế bằng đường dẫn ảnh: st.image("path_to_extracted_sketch.png")
        st.markdown(
            """
...
def process_chat_input():
    ...
    # Logic thuật toán toán học IE tính định mức từ prompt văn bản
    ...
    # Đồng bộ trực tiếp lên bộ đếm trên cùng trang
